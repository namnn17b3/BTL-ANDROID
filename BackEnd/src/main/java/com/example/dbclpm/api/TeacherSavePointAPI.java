...
@WebServlet(urlPatterns={"/api/teacher/save-point"}, loadOnStartup=1)
public class TeacherSavePointAPI extends HttpServlet {
    ...
    private static final MqttHandler mqttHandler = new MqttHandler("server-single");
    ...
    public void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Student student = dao.getStudentByPointId(pointId);
        ...
        String note = scoreByWord.equals("F") ? "Không đạt" : PointUtils.genNote(cc, btl, th, ktgk, ktck);
