...
@WebServlet("/api/student/term-subjects")
public class StudentTermAndSubjectsAPI extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    	...
    	List<TermAndSubjectsDto> list = dao.getTermAndSubjectsByStudentId(student.getId());
